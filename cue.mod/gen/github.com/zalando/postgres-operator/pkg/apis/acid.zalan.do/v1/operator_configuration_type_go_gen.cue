...
#KubernetesMetaConfiguration: {
	...
	oauth_token_secret_name?:          spec.#NamespacedName   @go(OAuthTokenSecretName)
	infrastructure_roles_secret_name?: spec.#NamespacedName   @go(InfrastructureRolesSecretName)
	...
	pod_environment_configmap?:     spec.#NamespacedName @go(PodEnvironmentConfigMap)
